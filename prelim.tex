...
They aid in our digestion of food, have been associated with different diseases, and even help identify which keyboard and mouse we use.
In the environment, these microbes are responsible for the most of the biochemical cycles that allow life to exist on earth, such as the carbon and nitrogen cycle.
...
In typical analyses, the short fragments produced from sequencing technologies need to be clustered into similar groups based on some definition of similarity.
...
First, we will discuss multi-core algorithms to speedup the runtime of clustering.
Then, we will describe efficient string matching algorithms and how to use the high sequencing similarity to quickly recruit sequences to potential cluster centers.
Lastly, we will discuss multiple strategies for handling sequences that can align to multiple centers.
